...
const EyeglassesEdit = () => {
  ...
  return (
    <div>
      <HeaderContainer>
        <PageHeader category="Eyeglasses" title={productId ? 'Update Eyeglasses' : 'Ceate Eyeglasses'} />
        {productId &&
          <Button
            ...
            return (
              <FormInput key={attribute.label}>
                <InputSelect
                  ...
                  value={values?.attributes ? values.attributes['material'] : 0}
                  defaultValue={0}
